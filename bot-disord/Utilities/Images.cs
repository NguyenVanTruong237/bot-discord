...
namespace bot_disord.Utilities
{
    public class Images
    {
        public async Task<string> CreateImageAsync (SocketGuildUser user)
        {
            ...
            var background = await FetchImageAsync("https://images.unsplash.com/photo-1517879288527-682ff596b022?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80");
